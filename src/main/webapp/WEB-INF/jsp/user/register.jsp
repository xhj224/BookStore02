        ...
        <div class="left_content">
            ...
            <div class="feat_prod_box_details">
                ...
                <div class="contact_form">
                    ...
                    <form name="register" action="${base}/user/register" method="post">
                        <div class="form_row">
                            <label class="contact"><strong>用户名:</strong></label>
                            <input id="username" type="text" name="username" class="contact_input"
                        ...
                        <div class="form_row">
                            ...
                            <input type="tel" name="tel" class="contact_input" required/>
                        </div>

                        <div class="form_row">
                            <label class="contact"><strong>公司:</strong></label>
                            <input type="text" name="comparate" class="contact_input" required/>
                        </div>
...
<script>
    ...
    function checkUsername() {
        ...
        var url = "${base}/user/validateName?username=" + username;
        url = encodeURI(url);
        url = encodeURI(url);
