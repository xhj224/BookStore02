...
<div id="wrap">
    ...
    <div class="header">
        <div class="logo"><a href="${base}/book/IndexAction"><img src="${base}/images/logo.gif" alt="" title="" border="0"/></a></div>
        <div id="menu">
            <ul>
    ...
    <div class="center_content">
        <div class="left_content">
            <div class="title"><span class="title_icon"><img src="${base}/images/bullet1.gif" alt="" title=""/></span>联系我们</div>
